...
public final class Enums {
    ...
    public static Suit makeSuit(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for Suit: " + value);
        }
    }
    ...
    public static Rank makeRank(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for Rank: " + value);
        }
    }
    ...
    public static HandType makeHandType(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for HandType: " + value);
        }
    }
    ...
    public static HandPhaseHoldem makeHandPhaseHoldem(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for HandPhaseHoldem: " + value);
        }
    }
    ...
    public static HandPhase5card makeHandPhase5card(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for HandPhase5card: " + value);
        }
    }
    ...
    public static ActionType makeActionType(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for ActionType: " + value);
        }
    }
    ...
    public static PotType makePotType(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for PotType: " + value);
        }
    }
    ...
    public static PlayerTableStatus makePlayerTableStatus(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for PlayerTableStatus: " + value);
        }
    }
    ...
    public static BuyInResultCode makeBuyInResultCode(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for BuyInResultCode: " + value);
        }
    }
    ...
    public static BuyInInfoResultCode makeBuyInInfoResultCode(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for BuyInInfoResultCode: " + value);
        }
    }
    ...
    public static ErrorCode makeErrorCode(int value) {
        switch(value) {
            ...
            default: throw new IllegalArgumentException("Invalid enum value for ErrorCode: " + value);
        }
    }
