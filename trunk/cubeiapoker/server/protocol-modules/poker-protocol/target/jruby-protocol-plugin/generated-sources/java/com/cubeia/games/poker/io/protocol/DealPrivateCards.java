...
public final class DealPrivateCards implements ProtocolObject, Visitable {
    public int classId() {
        return 13;
    }
     ...
     *
     */
    public DealPrivateCards() {
        // Nothing here
    }

    public DealPrivateCards(List<CardToDeal> cards) {
        this.cards = cards;
    }
    ...
    public String toString() {
        StringBuilder result = new StringBuilder("DealPrivateCards :");
